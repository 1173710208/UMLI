...
void test_UMLI_synthetic_4d(const char* fileName, const char* rfileName, int dim)
{
    cout << "==============================================================================================================" << endl;
    cout << "4D TEST" << endl;
    ...
    for (int i = 0; i < POINT_QUERY_SIZE; ++i)
    {
        ...
        for (int j = 0; j < dim; j++)
        {
            point_query[i][j] = data_arr[i + 990000][j];
        }
    }
    for (int i = 0; i < KNN_QUERY_SIZE; ++i)
    {
        ...
        for (int j = 0; j < dim; j++)
        {
            knn_query[i][j] = data_arr[i + 990000][j];
        }
    }
    ...
    vector<double> lscale1 = { 0,2,4,6,8,10 };
    vector<double> lscale2 = { 0,2,4,6,8,10 };
    vector<double> lscale3 = { 0,2,4,6,8,10 };
    vector<double> lscale4 = { 0,2,4,6,8,10 };
...
int mainTUC() {
    ...
    test_UMLI_synthetic_4d("./Datasets/uniform_4d_10000000.csv", "./Datasets/_range_uniform_4d_1000.csv", 4);
