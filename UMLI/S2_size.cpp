...
void s2test_normal_4d(const char* fileName, const char* rfileName, int dim)
{
    cout << "==============================================================================================================" << endl;
    cout << "4D TEST" << endl;
    ...
    for (int i = 0; i < POINT_QUERY_SIZE; ++i)
    {
        ...
        for (int j = 0; j < dim; j++)
        {
            point_query[i][j] = data_arr[i+4000000][j];
        }
    }
    for (int i = 0; i < KNN_QUERY_SIZE; ++i)
    {
        ...
        for (int j = 0; j < dim; j++)
        {
            knn_query[i][j] = data_arr[i + 4000000][j];
        }
    }
...
int mainsd2() {
  ...
  //  s2test_normal_4d("./Datasets/normal_4d_100000.csv", "./Datasets/_range_normal_4d_1000.csv", 4);
//    s2test_normal_4d("./Datasets/normal_4d_500000.csv", "./Datasets/_range_normal_4d_1000.csv", 4);
    //s2test_normal_4d("./Datasets/normal_4d_1000000.csv", "./Datasets/_range_normal_4d_1000.csv", 4);
    s2test_normal_4d("./Datasets/normal_4d_5000000.csv", "./Datasets/_range_normal_4d_1000.csv", 4);
    s2test_normal_4d("./Datasets/normal_4d_10000000.csv", "./Datasets/_range_normal_4d_1000.csv", 4);
