/*
This is a test program to verify the correctness of each indexing algorithm.
*/
...
*/
void test_correctness_2d(const char* fileName, const char* rfileName, const int dim)
{
    cout << "==============================================================================================================" << endl;
    cout << "2D TEST" << endl;
    ...
    UMLI<int, double, 2> umli(id_arr, umli_build_arr, linear_scales_UMLI, 6);
...
* @param dim NUmber of dimensions
*/
void test_correctness_3d(const char* fileName, const char* rfileName, const int dim)
{
    cout << "==============================================================================================================" << endl;
    cout << "3D TEST" << endl;
...
int mainC() {
    ...
    test_correctness_2d("./Datasets/C_2d_10000.csv", "./Datasets/C_2d_10_range.csv", 2);
    //test_correctness_3d("./Datasets/C_3d_10000.csv", "./Datasets/C_3d_10_range.csv",  3);
